...
import neonique.cbcplugin_new.gamemodes.ctf.CTFGameCommands;
...
public class FlagRushGameCommands extends CTFGameCommands {

    FlagRushGame game;

    public FlagRushGameCommands(GameManager gm, CombatManager wm, FlagRushGame game) {
        super(gm, wm, game);
        this.game = game;
    }
