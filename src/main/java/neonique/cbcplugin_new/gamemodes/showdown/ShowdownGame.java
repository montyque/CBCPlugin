...
public class ShowdownGame extends TeamGame<ShowdownPlayer, ShowdownTeam> {
    ...
    public void setupRound () {
        ...
        playSound(Sound.sound(org.bukkit.Sound.ENTITY_PLAYER_LEVELUP, Sound.Source.MASTER,200, 1));
        ...
        if (killer == null) {
            ...
            subtitle = Component.text()
                    .append(Component.text()
                            .content("Eliminated by ")
                            .color(NamedTextColor.YELLOW))
                    .append(Component.object(ObjectContents.playerHead(killer.getUUID()))
    ...
    public void startSuddenDeath () {
        ...
        playSound(Sound.sound(org.bukkit.Sound.ENTITY_WITHER_DEATH, Sound.Source.MASTER, 200, 1));
