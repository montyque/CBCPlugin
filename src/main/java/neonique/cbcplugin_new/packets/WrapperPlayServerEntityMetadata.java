package neonique.cbcplugin_new.packets;
...
public class WrapperPlayServerEntityMetadata extends AbstractPacket {
    ...
    public void removeFromDataValueCollection(Object value) {

        List<WrappedDataValue> collection = getDataValueCollection();
        List<WrappedDataValue> newCollection = new ArrayList<>();
        for (WrappedDataValue val : collection) {
            if (val.getValue() != value) {
                newCollection.add(val);
            }
        }
        setDataValueCollection(newCollection);
    }
